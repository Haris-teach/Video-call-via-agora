...
const config = {
  appId: "9845a91ead18424289a026d41911c309",
  token: "0069845a91ead18424289a026d41911c309IABwbUTbgBJc2gu07rz49o1MOU/95W/CalMtXqipCbqqB5tRn3IAAAAAEACiqr7Mbui/YgEAAQBu6L9i",
  channelName: 'room',
};
  ...
  return (
    <View style={styles.max}>
      <View style={styles.max}>
        ...
        <View style={styles.buttonHolder}>
          <TouchableOpacity onPress={()=>_engine.current?.switchCamera()} style={styles.button}>
